...
<script>
    import HeroInner from "./house/HeroInner";
    import HeroSlot from "./index/HeroSlot";
    import HouseInner from "./house/HouseInner";
    import MySlot from "./index/MySlot";
    import BrandSlot from "./index/BrandSlot";
    import PropertySlot from "./index/PropertySlot";
    export default {
        name: "Index2",
